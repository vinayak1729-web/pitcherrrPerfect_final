...
from personalizedBody import generate_email_body
from dotenv import load_dotenv
load_dotenv()
email_sender = os.getenv('EMAIL_USER')
sender_password = os.getenv('EMAIL_PASS')

def send_personalized_email(recipient_email, username, sender_email, sender_password):
    """Sends a formatted HTML email."""

    subject = "Welcome to Pitcher Perfect!"
    body = generate_email_body(username)
